  ...
  return (
    <Card className="overflow-hidden">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-line px-5 py-3.5">
        ...
        <Pill tone="sage">{(RATE * 100).toFixed(0)}% CAGR index ETF</Pill>
      </div>
      ...
      <div className="px-5 py-5">
        ...
        <div className="mt-2 flex items-center gap-2 rounded-md border border-line bg-surface-2 px-3 focus-within:border-forest">
          <span className="figure text-lg text-meta">₹</span>
          <input
            id="impulse"
            type="number"
            min={0}
        ...
        >
          ...
          >
            ...
            <span className="figure mt-0.5 block text-[13px] text-meta">
              {inr(amount)} spent
            </span>
          </button>
          <button
        ...
        <div className="mt-5 rounded-md border border-line bg-surface-2 p-4">
          {mode === "invest" ? (
            <>
              ...
              <p className="mt-2 flex items-start gap-1.5 text-[13px] leading-relaxed text-meta">
            ...
            <>
              ...
              <p className="figure mt-1 text-3xl font-semibold tracking-tight text-ochre-ink">
                −{inr(future - amount)}
              </p>
          ...
          <div className="mt-2 grid grid-cols-2 gap-px overflow-hidden rounded-md border border-line bg-line">
            {eq.map((e) => (
              <div key={e.id} className="bg-surface px-3 py-2.5">
                ...
                <p className="mt-0.5 text-[11px] leading-tight text-meta">
                  {e.unit} · {e.label}
                </p>
              </div>
            ))}
